...
def getWorld2View2(R, t, translate=np.array([.0, .0, .0]), scale=1.0):
    ...
    cam_center = C2W[:3, 3]
    # from scene.cameras import get_Rx, get_Ry, get_Rz
    # C2W[:3, :3] = get_Rz(-2/180 * math.pi) @ C2W[:3, :3]
    # C2W[:3, :3] = get_Ry(-2/180 * math.pi) @ C2W[:3, :3]
    # C2W[:3, :3] = get_Rx(-2/180 * math.pi) @ C2W[:3, :3]
